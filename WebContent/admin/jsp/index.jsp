...
<body>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form id="add_todo" class="form-inline " action="javascript:;">
								<div class="form-group">
									<input id="todo_content" type="text" class="form-control" name="content" style="height:34px;width:400px;">
								</div>
	...
	<!--[if lte IE 8]>
		<script language="javascript" type="text/javascript" src="/myBlogs/admin/proton/assets/plugins/excanvas/excanvas.min.js"></script>
	<![endif]-->
	...
	<script>
		$(function(){
			...
			$('#btn_add').click(function(){
				var content = $.trim($('#todo_content').val());
				if(!content){
					jAlert('任务内容未填写');
					return;
				}
