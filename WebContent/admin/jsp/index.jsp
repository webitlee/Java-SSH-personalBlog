			...
			<div class="sidebar ">
				...
				<div class="sidebar-collapse">
					<div class="sidebar-header t-center">
                        <span><img class="text-logo" src="/myBlogs/admin/proton/assets/img/logo1.png"><i class="fa fa-space-shuttle fa-3x blue"></i></span>
                    </div>										
				...
				<div class="sidebar-footer">					
					...
					<div class="copyright text-center">
						<small>Proton <i class="fa fa-coffee"></i> from <a href="http://www.cssmoban.com/" title="ç½é¡µæ¨¡æ¿" target="_blank">ç½é¡µæ¨¡æ¿</a></small>
					</div>					
				</div>	
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									...
									<tr>
										<td><img src="/myBlogs/admin/proton//ico/flags/usa.png" style="height:18px; margin-top:-2px;"></td>
										<td>USA</td>
										<td>4856</td>
										<td>3621</td>
										<td>
