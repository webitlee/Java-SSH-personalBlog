							...
							<div class="panel-body">
								<form class=" form-horizontal " action="javascript:;">
									...
									<div class="questions form-group" style="display:none;">
										<label class="control-label   col-md-5">问题1
										</label>
										<div class="col-md-7">
									...
									<div class="questions form-group"  style="display:none;">
										<label class="control-label   col-md-5">问题2
										</label>
										<div class="col-md-7">
											<input type="text" class="form-control" placeholder="请输入答案">
										</div>
									...
									<div class="questions form-group"  style="display:none;">
										<label class="control-label   col-md-5">问题3
										</label>
										<div class="col-md-7">
											<input type="text" class="form-control" placeholder="请输入答案">
										</div>
 	...
 	<script src="/myBlogs/admin/proton/assets/plugins/datatables/js/jquery.dataTables.min.js"></script>
   	...
   	<script>
   		...
   		$('#btn_username').click(function(){
   			...
   			$.get('/myBlogs/getSecurityQuestions', {username : username}, function(data){
   				if(data.error){
